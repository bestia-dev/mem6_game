...
rustuse crate::rootrenderingcomponentmod::RootRenderingComponent;
...
rust    // Mount the component to the `<div id="div_for_virtual_dom">`.
...
rust    pub fn start_websocket(&mut self, vdom: VdomWeak) {
...
rust        // html fragment from html_template defined in # local_route
